...
<head>
    <meta charset="UTF-8">
    <title>REPORT DATA JAWABAN SISWA - {{ $bank->name }}</title>
    <style>
        @page {
            size: A4 portrait;
            margin: 10mm;
...
<body>
    ...
    <!-- Title Banner -->
    <div class="header-title">DATA PEMERIKSAAN JAWABAN SISWA</div>
    <div class="header-subtitle">TIPE SOAL : PILIHAN GANDA BIASA (MULTIPLE CHOICE)</div>
    ...
    <table class="key-box-table">
        <tr>
            <td style="width: 20%; background-color: #d9d9d9; font-weight: bold;" rowspan="2">
                DATA KHUSUS<br>SOAL PILIHAN GANDA
            </td>
            <td style="width: 48%; background-color: #d9d9d9; font-weight: bold;">
                RINCIAN KUNCI JAWABAN
            </td>
            <td style="width: 7%; background-color: #d9d9d9; font-weight: bold;">JUMLAH SOAL</td>
            <td style="width: 7%; background-color: #d9d9d9; font-weight: bold;">JUMLAH OPTION</td>
            <td style="width: 6%; background-color: #d9d9d9; font-weight: bold;">SKOR BENAR</td>
            <td style="width: 6%; background-color: #d9d9d9; font-weight: bold;">SKOR SALAH</td>
            <td style="width: 6%; background-color: #d9d9d9; font-weight: bold;">SKALA</td>
            <td style="width: 6%; background-color: #d9d9d9; font-weight: bold;">NILAI</td>
        </tr>
        <tr>
            <td class="key-string text-center">{{ $answer_keys_string }}</td>
            <td class="text-center font-bold" style="background-color: #c6efce;">{{ count($questions) }}</td>
            <td class="text-center font-bold" style="background-color: #c6efce;">{{ $max_option_count }}</td>
            <td class="text-center font-bold" style="background-color: #c6efce;">1</td>
            <td class="text-center font-bold" style="background-color: #c6efce;">0</td>
            <td class="text-center font-bold" style="background-color: #c6efce;" colspan="2">100</td>
        </tr>
    </table>
    ...
    <table class="student-table">
        <thead>
            <tr>
                <th style="width: 4%;" rowspan="2">No. Urut</th>
                <th style="width: 24%;" rowspan="2">Nama Siswa</th>
                <th style="width: 4%;" rowspan="2">L/P</th>
                <th style="width: 36%;" rowspan="2">
                    RINCIAN JAWABAN SISWA<br>
                    <span style="font-weight: normal; font-size: 7.5pt;">(Huruf kapital opsi yang dipilih siswa)</span>
                </th>
                <th style="width: 10%;" colspan="2">JUMLAH</th>
                <th style="width: 7%;" rowspan="2">SKOR</th>
                <th style="width: 7%;" rowspan="2">NILAI</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center font-bold" style="color: {{ $row['is_tuntas'] ? '#375623' : '#c00000' }};">
                    {{ $row['ket'] }}
                </td>
            </tr>
            @empty
            ...
            <tr class="summary-row" style="background-color: #f2f2f2; font-weight: bold;">
                <td colspan="4" class="text-right">TERKECIL :</td>
            ...
            <tr class="summary-row" style="background-color: #f2f2f2; font-weight: bold;">
                <td colspan="4" class="text-right">TERBESAR :</td>
            ...
            <tr class="summary-row" style="background-color: #f2f2f2; font-weight: bold;">
                <td colspan="4" class="text-right">SIMPANGAN BAKU :</td>
