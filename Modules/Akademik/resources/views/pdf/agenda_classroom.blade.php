...
<head>
    ...
    <title>Jurnal Kelas - {{ $classroom->name }}</title>
    <style>
        @page {
        ...
        .header h3 { margin: 2px 0; font-size: 10pt; font-weight: bold; text-transform: uppercase; }
...
<body>
    <div class="header">
        <h2>JURNAL KELAS</h2>
        <h3>KELAS: {{ $classroom->name }} · SMA NEGERI 16 SEMARANG</h3>
        <p>Bulan: <strong>{{ $monthName }} {{ $year }}</strong> | Wali Kelas: <strong>{{ $teacher->full_name }}</strong></p>
    </div>
    ...
    @foreach($reports as $date => $dayAgendas)
        ...
        <table class="agenda-table">
            <thead>
                <tr>
                    <th rowspan="2" width="7%">Jam</th>
                    <th rowspan="2" width="20%">Guru & Mapel</th>
                    <th rowspan="2" width="28%">Materi & Tujuan Pembelajaran</th>
                    <th colspan="6" width="24%">Presensi</th>
                    <th rowspan="2" width="21%">Siswa Tidak Hadir</th>
                </tr>
                <tr>
                    <th width="4%">Jml</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <strong>{{ $agenda->teacher?->full_name }}</strong><br>
                        <span style="font-size: 8pt; color: #555;">{{ $agenda->subject?->name }}</span>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        @else
                            <span style="color: #15803d; font-style: italic; font-size: 7.5pt;">- (Nihil / Hadir Semua)</span>
                        @endif
                    </td>
                </tr>
                @endforeach
